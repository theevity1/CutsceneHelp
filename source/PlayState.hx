			...
			case 'injector':
				{
						defaultCamZoom = 0.1;
						curStage = 'injector';
						var bg:FlxSprite = new FlxSprite(0, 0).loadGraphic(Paths.image('spinel/sky'));
						bg.antialiasing = true;
						bg.setGraphicSize(Std.int(bg.width * 0.54));
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						add(bg);
						var bg2:FlxSprite = new FlxSprite(0, 0).loadGraphic(Paths.image('spinel/injector'));
						bg2.antialiasing = true;
						bg2.setGraphicSize(Std.int(bg2.width * 0.54));
						bg2.scrollFactor.set(0.9, 0.9);
						bg2.active = false;
						add(bg2);
	
						var stageFront:FlxSprite = new FlxSprite(0, 0).loadGraphic(Paths.image('spinel/floor'));
						stageFront.setGraphicSize(Std.int(stageFront.width * 0.54));
